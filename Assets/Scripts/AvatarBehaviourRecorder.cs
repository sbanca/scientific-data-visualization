...
public class AvatarBehaviourRecorder : MonoBehaviour
{
    ...
    Vector3 PointerHeadTilt1 = Vector3.zero;

    Vector3 PointerHeadTilt2 = Vector3.zero;
    ...
    string PointerHeadTilt1String;
    string PointerHeadTilt2String;
    ...
    void Update()
    {
        ...
        if (rayOnMap != null)
        {
            ...
            PointerHeadTilt1 = rayOnMap.HeadRay() == null ? Vector3.zero : (Vector3)rayOnMap.HeadRayTilt();
            PointerHeadTilt2 = rayOnMap.RemoteHeadRay() == null ? Vector3.zero : (Vector3)rayOnMap.RemoteHeadRayTilt();
            ...
            PointerHeadTilt1String = PointerHeadTilt1 == Vector3.zero ? "null,null,null" : PointerHeadTilt1.ToString("F3");
            PointerHeadTilt2String = PointerHeadTilt2 == Vector3.zero ? "null,null,null" : PointerHeadTilt2.ToString("F3");
