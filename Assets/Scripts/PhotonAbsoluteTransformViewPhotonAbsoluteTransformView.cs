...
namespace Photon.Pun
{
    ...
    public class PhotonAbsoluteTransformView : MonoBehaviour, IPunObservable
    {
        ...
        public void Awake()
        {
            ...
            m_WorldPosition = transform.localToWorldMatrix * transform.position;

            m_StoredPosition = m_WorldPosition;
        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            if (stream.IsWriting)
            {
                ...
                {
                    this.m_WorldPosition = transform.localToWorldMatrix * transform.position;
                    this.m_Direction = this.m_WorldPosition - this.m_StoredPosition;
                    this.m_StoredPosition = this.m_WorldPosition;

                    stream.SendNext(this.m_WorldPosition);
